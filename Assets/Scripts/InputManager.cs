...
public class InputManager : MonoBehaviour
{
    ...
    [SerializeField] private InteractionManager interactionManager; // Reference to InteractionManager

    private PlayerInputActions playerInputActions;
    private InputAction playerFireAction;
    ...
    void Awake()
    {
        ...
        playerFireAction = playerInputActions.Player.Fire;
    }

    void OnEnable()
    {
        interactionManager = FindObjectOfType<InteractionManager>();
        playerLocomotionHandler = FindObjectOfType<PlayerLocomotionHandler>();
        playerFireAction.Enable();
    }
